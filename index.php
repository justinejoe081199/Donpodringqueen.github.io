...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">Joe-Justine@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+639569903689</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Don <span>Podring</span><p class="logo_w3l_agile_caption">Queen Orchestra</p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Events</a></li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4>Don Podring<span>Queen Orchestra</span></h4>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2>EVENT RESERVATION</h2></a>
</div>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>EXPERIENCE A SYMPHONY OF COMFORT, ENJOY HARMONIOUS OFFERS</span> Discover Our Warm and Inviting Overture</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">INSTRUMENTALS</h4>
							<span class="cbp-ig-category">Don Podring Queen</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							
							<h4 class="cbp-ig-title">QUEEN DANCER'S</h4>
							<span class="cbp-ig-category">Don Podring Queen</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">SINGER'S</h4>
							<span class="cbp-ig-category">Don Podring Queen</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
							...
							<h4 class="cbp-ig-title">SOUND'S & LIGHT'S</h4>
							<span class="cbp-ig-category">Don Podring Queen</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">About Don Podring</h3> 
						   <p class="about-para-w3ls">The Don Podring Queen Orchestra is the epitome of joy and excitement, bringing infectious energy and unforgettable melodies to every fiesta or event they grace with their presence. With their dynamic performances and vibrant stage presence, they have the remarkable ability to uplift spirits and create an atmosphere of celebration wherever they go. </p>
						   <img src="images/about1.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
										    <h4>You'll love all the Events we offer!</h4>
											<p>DON PODRING QUEEN ORCHESTRA </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
<div class="team" id="team">
	<div class="container">
			...
			<div id="horizontalTab">
					...
					<li>
						<img src="images/teams8.jpg" alt=" " class="img-responsive" />
					</li>
					</ul>
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Events And Rates</h3>
